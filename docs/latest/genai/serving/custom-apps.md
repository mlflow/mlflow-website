...
4. **Serialization**: Use [`models-from-code`](/mlflow-website/docs/latest/ml/model/models-from-code.md) feature when logging models that are not picklable

### Debugging Tips[​](#debugging-tips "Direct link to Debugging Tips")

* 🧾 **Enable [tracing](/mlflow-website/docs/latest/genai/tracing.md)** to track execution flow
