...
You can use [`mlflow.genai.evaluate()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.genai.html#mlflow.genai.evaluate) to evaluate your agent. See the [Evaluating Agents](/mlflow-website/docs/latest/genai/eval-monitor.md) guide and [Scorer](/mlflow-website/docs/latest/genai/eval-monitor/scorers.md) documentation for more information.
