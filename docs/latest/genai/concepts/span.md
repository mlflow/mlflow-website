...
The Span object is a fundamental building block in the [Trace](/mlflow-website/docs/latest/genai/concepts/trace.md) data model. It is a container for the information about the individual steps of the trace, such as LLM calls, tool execution, retrieval, etc. Spans form a hierarchical tree structure within a single trace, which represents the execution flow of the trace.

![Example of a Span for a Tool Calling Agent](/mlflow-website/docs/latest/images/llms/tracing/schema/span_architecture.png)
...
![Search Spans by Type](/mlflow-website/docs/latest/assets/images/search_spans_by_type-ddb1e2356a4b8ba83b6cb59c04fffc89.png)
