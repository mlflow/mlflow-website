...
![Overview of DSPy and MLflow integration](/mlflow-website/docs/latest/assets/images/dspy-integration-architecture-ee130c78236e38d9728f2a818bf024e9.png)
...
* [MLflow Tracking](/mlflow-website/docs/latest/ml/tracking.md) allows you to track your DSPy program's training and execution. With the MLflow APIs, you can log a variety of artifacts and organize training runs, thereby increasing visibility into your model performance.
* [MLflow Model](/mlflow-website/docs/latest/ml/model.md) packages your compiled DSPy program along with its dependency versions, input and output interfaces and other essential metadata. This allows you to deploy your compiled DSPy program with ease, knowing that the environment is consistent across different stages of the ML lifecycle.
...
[DSPy Quickstart](/mlflow-website/docs/latest/genai/flavors/dspy/notebooks/dspy_quickstart.md)

[Get started with MLflow and DSPy by exploring the simplest possible configuration of a DSPy program.](/mlflow-website/docs/latest/genai/flavors/dspy/notebooks/dspy_quickstart.md)
...
Learn more about MLflow DSPy tracing capabilities [here](/mlflow-website/docs/latest/genai/tracing/integrations/listing/dspy.md).
...
You can log the `dspy.Module` object to an MLflow run using the [`mlflow.dspy.log_model()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.dspy.html#mlflow.dspy.log_model) function.

We will also specify a [model signature](/mlflow-website/docs/latest/ml/model/signatures.md#automatic-signature-inference). An MLflow model signature defines the expected schema for model inputs and outputs, ensuring consistency and correctness during model inference.
...
The saved module can be loaded back for inference using the [`mlflow.pyfunc.load_model()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.pyfunc.html#mlflow.pyfunc.load_model) function. This function gives an MLflow Python Model backed by the DSPy module.
...
The MLflow DSPy flavor supports autologging for DSPy optimizers. See the [Optimizer Autologging](/mlflow-website/docs/latest/genai/flavors/dspy/optimizer.md) page for details.
