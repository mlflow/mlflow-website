...
To learn more about autologging support for the OpenAI flavor, please [see the autologging guide](/mlflow-website/docs/latest/genai/flavors/openai/autologging.md).
...
![A primer on RLHF for sophisticated LLM training](/mlflow-website/docs/latest/assets/images/RLHF-architecture-8865bb6fa6abd94c3f2fd3d31a290ea6.png)
