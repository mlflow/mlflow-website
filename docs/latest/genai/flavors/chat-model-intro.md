...
4. How [`ChatModel`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.pyfunc.html#mlflow.pyfunc.ChatModel) compares to [`PythonModel`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.pyfunc.html#mlflow.pyfunc.PythonModel) for defining custom chat models
...
* MLflow version 2.17.0 or higher installed for use of [`ChatModel`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.pyfunc.html#mlflow.pyfunc.ChatModel).
...
![ChatModel Interface](/mlflow-website/docs/latest/assets/images/interface_1-eef793eaf139821002cfdb770dcd608d.png)
...
You can find details of the full chat response object [here](/mlflow-website/docs/latest/api_reference/python_api/mlflow.types.html#mlflow.types.llm.ChatCompletionResponse).
...
To demonstrate this mapping process, we will show how to use the [`mlflow.pyfunc.ChatModel`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.pyfunc.html#mlflow.pyfunc.ChatModel) class to log Meta's Llama 3.2 1B model via the Ollama llm client, which does not have a native MLflow flavor.
...
1. Define a class that extends [`mlflow.pyfunc.ChatModel`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.pyfunc.html#mlflow.pyfunc.ChatModel)
...
In a notebook environment, we can save the model to a file called `ollama_model.py` with the `%%writefile` magic command and call `set_model(SimpleOllamaModel())`. This is the "models from code" approach to model logging, which you can read more about [here](/mlflow-website/docs/latest/ml/model/models-from-code.md).
...
* How [`ChatModel`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.pyfunc.html#mlflow.pyfunc.ChatModel) compares to the [`PythonModel`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.pyfunc.html#mlflow.pyfunc.PythonModel) for defining custom chat models
...
To learn more about these and other advanced features of the ChatModel API, you can read [this guide](/mlflow-website/docs/latest/genai/flavors/chat-model-guide.md).
