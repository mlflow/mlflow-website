...
## Core Framework Changes[​](#core-framework-changes "Direct link to Core Framework Changes")

### MLflow Recipes Removal[​](#mlflow-recipes-removal "Direct link to MLflow Recipes Removal")
...
### AI Gateway Configuration Changes[​](#ai-gateway-configuration-changes "Direct link to AI Gateway Configuration Changes")

**What's changing:** The 'routes' and 'route\_type' config keys in the gateway server configuration have been removed ([#15331](https://github.com/mlflow/mlflow/pull/15331)).
...
### MLflow Deployment Server Removal[​](#mlflow-deployment-server-removal "Direct link to MLflow Deployment Server Removal")
...
## Model Flavor Changes[​](#model-flavor-changes "Direct link to Model Flavor Changes")

### fastai Flavor Removal[​](#fastai-flavor-removal "Direct link to fastai Flavor Removal")
...
### mleap Flavor Removal[​](#mleap-flavor-removal "Direct link to mleap Flavor Removal")
...
#### `run_uuid` Attribute Removal[​](#run_uuid-attribute-removal "Direct link to run_uuid-attribute-removal")
...
#### Git Tag Changes[​](#git-tag-changes "Direct link to Git Tag Changes")
...
#### TensorFlow Autologging Change[​](#tensorflow-autologging-change "Direct link to TensorFlow Autologging Change")
...
#### Parameter Removals[​](#parameter-removals "Direct link to Parameter Removals")
...
#### Other Model Changes[​](#other-model-changes "Direct link to Other Model Changes")
...
#### Baseline Model Comparison Removal[​](#baseline-model-comparison-removal "Direct link to Baseline Model Comparison Removal")
...
#### MetricThreshold Constructor Change[​](#metricthreshold-constructor-change "Direct link to MetricThreshold Constructor Change")
...
#### Custom Metrics Parameter Removal[​](#custom-metrics-parameter-removal "Direct link to Custom Metrics Parameter Removal")
...
### Environment Variable Changes[​](#environment-variable-changes "Direct link to Environment Variable Changes")
...
### `mlflow.evaluate` no longer logs an explainer as a model by default.[​](#mlflowevaluate-no-longer-logs-an-explainer-as-a-model-by-default "Direct link to mlflowevaluate-no-longer-logs-an-explainer-as-a-model-by-default")
