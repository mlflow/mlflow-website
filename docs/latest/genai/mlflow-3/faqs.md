...
You can modify `requirements.txt` of your model using [`mlflow.models.update_model_requirements()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.models.html#mlflow.models.update_model_requirements) to add or remove requirements. Here's an example of how to add a requirement to the model:
