...
To create datasets from traces or scratch, see [Build evaluation datasets](/mlflow-website/docs/latest/genai/datasets.md).
...
For production, convert to an [MLflow Evaluation Dataset](/mlflow-website/docs/latest/genai/datasets.md).
...
The DataFrame must comply with the [evaluation dataset schema](/mlflow-website/docs/latest/genai/datasets/sdk-guide.md#evaluation-dataset-schema).
