...
[AI Gateway](/mlflow-website/docs/latest/genai/governance/ai-gateway.md) endpoints are the recommended way to configure judge models, especially when creating judges from the UI. Benefits include:
