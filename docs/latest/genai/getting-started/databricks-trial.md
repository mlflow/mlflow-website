...
![MLflow Tracing Tutorial](/mlflow-website/docs/latest/assets/images/tracing-tutorial-1b928a4c8f71cd8f0da3d28e1c556a54.png)
...
![Databricks Trial Landing Page](/mlflow-website/docs/latest/assets/images/landing-page-6afce12b5b407957ce0a58a117d64d5b.png)
...
![Databricks Trial MLflow UI](/mlflow-website/docs/latest/assets/images/experiments-page-851d07c550322e143c7b78282a0b47e7.png)
...
![Databricks Workspace import Notebook from MLflow docs website](/mlflow-website/docs/latest/assets/images/import-notebook-dd63c143b3ebaa8b35b026e9088d4035.png)
...
To set up Databricks Workspace authentication, we can use the API [`mlflow.login()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.html#mlflow.login), which will prompt you for required information:
...
![Landing page of Databricks MLflow server](/mlflow-website/docs/latest/assets/images/databricks-lighthouse-landing-page-8719ea229bc7e60265499aef09ae3ffd.png)

In the "Experiments" view, you should be able to find the experiment "check-databricks-connection", similar to

![Experiment view of Databricks MLflow server](/mlflow-website/docs/latest/assets/images/databricks-lighthouse-experiment-view-71da0c93ad8b015942690ab9c13aef55.png)
...
![Run view of Databricks MLflow server](/mlflow-website/docs/latest/assets/images/databricks-lighthouse-run-view-2010f6cb028c069c95e9a57661464921.png)
