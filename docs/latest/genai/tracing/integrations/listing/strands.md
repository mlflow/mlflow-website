...
![Agno Tracing via autolog](/mlflow-website/docs/latest/images/llms/strands/strands-tracing.png)
...
[MLflow Tracing](/mlflow-website/docs/latest/genai/tracing/integrations.md) provides automatic tracing capability for Strands Agents SDK. By enabling auto tracing for Strands Agents SDK by calling the [`mlflow.strands.autolog()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.html#mlflow.strands.autolog) function, MLflow will capture traces for Agent invocation and log them to the active MLflow Experiment.
