...
![OpenAI Tracing via autolog](/mlflow-website/docs/latest/images/llms/tracing/openai-tracing.gif)
...
MLflow OpenAI integration is not only about tracing. MLflow offers full tracking experience for OpenAI, including model tracking, prompt management, and evaluation. Please checkout the **[MLflow OpenAI Flavor](/mlflow-website/docs/latest/genai/flavors/openai.md)** to learn more!
