...
[MLflow Tracing](/mlflow-website/docs/latest/genai/tracing/integrations.md) provides automatic tracing capability for <!-- -->Kimi (Moonshot AI)<!-- --> models through the OpenAI SDK integration. Since <!-- -->Kimi (Moonshot AI)<!-- --> offers an OpenAI-compatible API format, you can use<!-- --> `mlflow.openai.autolog()` to trace interactions with <!-- -->Kimi<!-- --> models.
...
![Kimi Tracing](/mlflow-website/docs/latest/images/llms/tracing/basic-openai-trace.png)
...
MLflow supports tracing for streaming and async <!-- -->Kimi<!-- --> APIs. Visit the<!-- --> [OpenAI Tracing documentation](/mlflow-website/docs/latest/genai/tracing/integrations/listing/openai.md) for example code snippets for tracing streaming and async calls through OpenAI SDK.
...
![Kimi Tracing with Manual Tracing](/mlflow-website/docs/latest/images/llms/tracing/openai-trace-with-manual-span.png)
