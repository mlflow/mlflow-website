...
[MLflow Tracing](/mlflow-website/docs/latest/genai/tracing/integrations.md) provides automatic tracing capability for <!-- -->Novita AI<!-- --> models through the OpenAI SDK integration. Since <!-- -->Novita AI<!-- --> offers an OpenAI-compatible API format, you can use<!-- --> `mlflow.openai.autolog()` to trace interactions with <!-- -->Novita AI<!-- --> models.
...
![Novita AI Tracing](/mlflow-website/docs/latest/images/llms/tracing/basic-openai-trace.png)
...
MLflow supports tracing for streaming and async <!-- -->Novita AI<!-- --> APIs. Visit the<!-- --> [OpenAI Tracing documentation](/mlflow-website/docs/latest/genai/tracing/integrations/listing/openai.md) for example code snippets for tracing streaming and async calls through OpenAI SDK.
...
![Novita AI Tracing with Manual Tracing](/mlflow-website/docs/latest/images/llms/tracing/openai-trace-with-manual-span.png)
