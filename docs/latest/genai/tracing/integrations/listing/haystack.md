...
![Haystack Tracing via autolog](/mlflow-website/docs/latest/images/llms/haystack/haystack-tracing.png)
...
[MLflow Tracing](/mlflow-website/docs/latest/genai/tracing/integrations.md) provides automatic tracing capability when using Haystack pipelines and components. When Haystack auto-tracing is enabled by calling the [`mlflow.haystack.autolog()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.html#mlflow.haystack.autolog) function, usage of Haystack pipelines and components will automatically record generated traces during interactive development.
