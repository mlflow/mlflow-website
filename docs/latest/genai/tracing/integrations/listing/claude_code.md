...
![Claude Code Tracing via CLI autolog](/mlflow-website/docs/latest/assets/images/claude-code-tracing-b1f69a5ecbf65655844589733ee28896.png)

[MLflow Tracing](/mlflow-website/docs/latest/genai/tracing.md) provides automatic tracing for Claude Code:
