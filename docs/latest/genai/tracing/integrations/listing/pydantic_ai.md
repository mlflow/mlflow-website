...
![PydanticAI Tracing via autolog](/mlflow-website/docs/latest/assets/images/pydanticai-tracing-794fbcf11fdb1407e2be31fefaec5536.png)
...
[MLflow Tracing](/mlflow-website/docs/latest/genai/tracing.md) provides automatic tracing capability for [​PydanticAI](https://ai.pydantic.dev/), an open source framework for building multi-agent applications. By enabling auto tracing for ​PydanticAI by calling the [`mlflow.pydantic_ai.autolog()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.pydantic_ai.html#mlflow.pydantic_ai.autolog) function, , MLflow will capture nested traces for ​PydanticAI workflow execution and logged them to the active MLflow Experiment.
...
![PydanticAI MCP Server tracing via autolog](/mlflow-website/docs/latest/assets/images/pydanticai-mcp-tracing-539c1eadbc3bf818d47f3daec180391a.png)
