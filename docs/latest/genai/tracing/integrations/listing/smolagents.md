...
![Smolagents tracing via autolog](/mlflow-website/docs/latest/assets/images/smolagents-tracing-ce4f2c411221b1c5d54a65e704e6a945.png)

MLflow Tracing provides automatic tracing capability when using Smolagents. When Smolagents auto-tracing is enabled by calling the [`mlflow.smolagents.autolog()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.smolagents.html#mlflow.smolagents.autolog) function, usage of the Smolagents SDK will automatically record generated traces during interactive development.
