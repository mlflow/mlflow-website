...
![LiveKit Agents Tracing](/mlflow-website/docs/latest/images/llms/tracing/livekit-tracing.png)

[MLflow Tracing](/mlflow-website/docs/latest/genai/tracing.md) provides automatic tracing capability for [LiveKit Agents](https://github.com/livekit/agents), an open-source framework for building real-time multimodal AI applications. MLflow supports tracing for LiveKit Agents through the [OpenTelemetry](/mlflow-website/docs/latest/genai/tracing/opentelemetry.md) integration.
...
### [Evaluate the Agent](/mlflow-website/docs/latest/genai/eval-monitor/running-evaluation/agents.md)

[Learn how to evaluate the agent's performance with LLM judges.](/mlflow-website/docs/latest/genai/eval-monitor/running-evaluation/agents.md)
...
### [Automatic Agent Optimization](/mlflow-website/docs/latest/genai/prompt-registry/optimize-prompts.md)

[Automatically optimize the agent end-to-end with state-of-the-art algorithms.](/mlflow-website/docs/latest/genai/prompt-registry/optimize-prompts.md)
