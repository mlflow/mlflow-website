...
![Agno Tracing via autolog](/mlflow-website/docs/latest/images/llms/agno/agno-tracing-basic.png)
...
[MLflow Tracing](/mlflow-website/docs/latest/genai/tracing/integrations.md) provides automatic tracing capability for Agno. By enabling auto tracing for Agno by calling the [`mlflow.agno.autolog()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.agno.html#mlflow.agno.autolog) function, MLflow will capture traces for Agent invocation and log them to the active MLflow Experiment.
