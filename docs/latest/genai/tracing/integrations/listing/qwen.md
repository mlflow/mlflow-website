...
[MLflow Tracing](/mlflow-website/docs/latest/genai/tracing/integrations.md) provides automatic tracing capability for <!-- -->Qwen (DashScope)<!-- --> models through the OpenAI SDK integration. Since <!-- -->Qwen (DashScope)<!-- --> offers an OpenAI-compatible API format, you can use<!-- --> `mlflow.openai.autolog()` to trace interactions with <!-- -->Qwen<!-- --> models.
...
![Qwen Tracing](/mlflow-website/docs/latest/images/llms/tracing/basic-openai-trace.png)
...
MLflow supports tracing for streaming and async <!-- -->Qwen<!-- --> APIs. Visit the<!-- --> [OpenAI Tracing documentation](/mlflow-website/docs/latest/genai/tracing/integrations/listing/openai.md) for example code snippets for tracing streaming and async calls through OpenAI SDK.
...
![Qwen Tracing with Manual Tracing](/mlflow-website/docs/latest/images/llms/tracing/openai-trace-with-manual-span.png)
