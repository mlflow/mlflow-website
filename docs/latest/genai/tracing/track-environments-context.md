...
* [`mlflow.update_current_trace()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.html#mlflow.update_current_trace) adds all key-value pairs to the active trace
...
**[MLflow Tracing UI](/mlflow-website/docs/latest/genai/tracing/observe-with-traces/ui.md)**: Learn to use the UI for filtering and analyzing traces by environment and version

**[Search Traces](/mlflow-website/docs/latest/genai/tracing/search-traces.md)**: Learn how to search and analyze traces with MLflow UI or API

**[Manual Tracing](/mlflow-website/docs/latest/genai/tracing/app-instrumentation/manual-tracing.md)**: Add detailed instrumentation with context-aware spans
