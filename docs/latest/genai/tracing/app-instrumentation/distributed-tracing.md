...
* Use the [`mlflow.tracing.get_tracing_context_headers_for_http_request()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.tracing.html#mlflow.tracing.get_tracing_context_headers_for_http_request) API in the client to fetch headers.
...
![Tracing Decorator](/mlflow-website/docs/latest/assets/images/distributed-tracing-fe2c7bb6f698ad0135204756a8b57a3e.png)
