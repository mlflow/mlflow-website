...
You may want to trace LLMs or frameworks that are not [supported](/mlflow-website/docs/latest/genai/tracing/integrations.md) by the MLflow Tracing SDK, or instrument applications written in languages other than Python and TypeScript/JavaScript.
