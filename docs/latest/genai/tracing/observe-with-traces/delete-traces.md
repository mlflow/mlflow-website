...
You can delete traces based on specific criteria using the [`mlflow.client.MlflowClient.delete_traces()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.client.html#mlflow.client.MlflowClient.delete_traces) method. This method allows you to delete traces by **experiment ID**, **maximum timestamp**, or **trace IDs**.
