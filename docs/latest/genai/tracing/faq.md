...
2. You call [`mlflow.search_traces()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.html#mlflow.search_traces)
...
You can customize what appears in the Request and Response columns of the trace list using [`mlflow.update_current_trace()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.html#mlflow.update_current_trace):
...
To register a custom hooks, use the [`mlflow.tracing.configure`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.tracing.html#mlflow.tracing.configure) API. For example, the following code filters out the document contents from the retriever span output to reduce the trace size:
...
To **disable** tracing, [`mlflow.tracing.disable()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.tracing.html#mlflow.tracing.disable) API will cease the collection of trace data from within MLflow and will not log any data to the MLflow Tracking service regarding traces.

To **enable** tracing (if it had been temporarily disabled), [`mlflow.tracing.enable()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.tracing.html#mlflow.tracing.enable) API will re-enable tracing functionality for instrumented models that are invoked.
...
You can delete traces using the [`mlflow.client.MlflowClient.delete_traces()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.client.html#mlflow.client.MlflowClient.delete_traces) method:
...
Read more about [trace deletion](/mlflow-website/docs/latest/genai/tracing/observe-with-traces/delete-traces.md).
...
For production monitoring, see [Production Tracing](/mlflow-website/docs/latest/genai/tracing/prod-tracing.md) for integration patterns.
...
Yes, MLflow provides comprehensive manual tracing capabilities. Please refer to the [Manual Tracing](/mlflow-website/docs/latest/genai/tracing/app-instrumentation/manual-tracing.md) guide for detailed information on creating traces and spans manually using decorators, context managers, and low-level APIs.
...
**Documentation**: Start with the [MLflow Tracing documentation](/mlflow-website/docs/latest/genai/tracing.md)
...
*For additional questions or issues not covered here, please check the [MLflow documentation](/mlflow-website/docs/latest/genai/tracing.md) or reach out to the community.*
