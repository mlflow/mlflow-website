...
## Quick Start with Prophet and MLflow[​](#quick-start-with-prophet-and-mlflow "Direct link to Quick Start with Prophet and MLflow")
...
## Understanding Prophet's Data Requirements[​](#understanding-prophets-data-requirements "Direct link to Understanding Prophet's Data Requirements")

Prophet has specific data format requirements that are important to understand:

### Data Format and Preparation[​](#data-format-and-preparation "Direct link to Data Format and Preparation")
...
#### Multiple Time Series[​](#multiple-time-series "Direct link to Multiple Time Series")
...
### Seasonality and Trend Configuration[​](#seasonality-and-trend-configuration "Direct link to Seasonality and Trend Configuration")
...
#### Built-in Holiday Support[​](#built-in-holiday-support "Direct link to Built-in Holiday Support")
...
### Cross-Validation Best Practices[​](#cross-validation-best-practices "Direct link to Cross-Validation Best Practices")
...
### Systematic Parameter Tuning[​](#systematic-parameter-tuning "Direct link to Systematic Parameter Tuning")
...
### Model Loading and Prediction[​](#model-loading-and-prediction "Direct link to Model Loading and Prediction")
...
### Forecast Accuracy Monitoring[​](#forecast-accuracy-monitoring "Direct link to Forecast Accuracy Monitoring")
...
### Data Preparation Best Practices[​](#data-preparation-best-practices "Direct link to Data Preparation Best Practices")
