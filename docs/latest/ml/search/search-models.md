...
Looking for guidance on searching over Runs? See the [Search Runs](/mlflow-website/docs/latest/ml/search/search-runs.md) documentation.
...
[`mlflow.search_logged_models()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.html#mlflow.search_logged_models) provides a convenient interface for model search:
...
[`mlflow.client.MlflowClient.search_logged_models()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.client.html#mlflow.client.MlflowClient.search_logged_models) offers more control with pagination support:
