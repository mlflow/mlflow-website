...
For production environments or team collaboration, consider hosting a shared [MLflow Tracking Server](/mlflow-website/docs/latest/self-hosting.md). For a fully-managed solution, get started with Databricks Free Trial by visiting the [Databricks Trial Signup Page](https://signup.databricks.com/?destination_url=/ml/experiments-signup?source=OSS_DOCS\&dbx_source=TRY_MLFLOW\&signup_experience_step=EXPRESS\&provider=MLFLOW\&utm_source=OSS_DOCS) and follow the instructions outlined there.
...
![MLflow UI Home page](/mlflow-website/docs/latest/images/tutorials/introductory/hyperparameter-tuning/ui-home.png)
...
![MLflow UI Run list page](/mlflow-website/docs/latest/images/tutorials/introductory/hyperparameter-tuning/ui-run-list.png)
...
Once you identified the best trial, you can register the model into [MLflow Model Registry](/mlflow-website/docs/latest/ml/model-registry.md) for promoting it to production.
...
* [MLflow Model Registry](/mlflow-website/docs/latest/ml/model-registry.md): Learn how to register and manage model lifecycle in the MLflow Model Registry.
