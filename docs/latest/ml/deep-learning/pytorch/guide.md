...
* [`mlflow.log_metric()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.html#mlflow.log_metric) / [`mlflow.log_metrics()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.html#mlflow.log_metrics): Log metrics like accuracy and loss during training
* [`mlflow.log_param()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.html#mlflow.log_param) / [`mlflow.log_params()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.html#mlflow.log_params): Log parameters like learning rate and batch size
* [`mlflow.pytorch.log_model()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.pytorch.html#mlflow.pytorch.log_model): Save your PyTorch model to MLflow
* [`mlflow.log_artifact()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.html#mlflow.log_artifact): Log artifacts like model checkpoints and visualizations

Best Practices for PyTorch Logging

#### Initialization Phase[​](#initialization-phase "Direct link to Initialization Phase")

* 📋 **Log Configuration Parameters**: Use [`mlflow.log_params()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.html#mlflow.log_params) at the beginning of training to record learning rate, batch size, optimizer configuration, etc.
* 🏗️ **Log Model Architecture**: Use `torchinfo` to generate a model summary and log it via [`mlflow.log_artifact()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.html#mlflow.log_artifact)
...
* 📈 **Use Batched Logging**: Prefer [`mlflow.log_metrics()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.html#mlflow.log_metrics) over multiple [`mlflow.log_metric()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.html#mlflow.log_metric) calls for better performance
...
* 💾 **Save Final Model**: Use [`mlflow.pytorch.log_model()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.pytorch.html#mlflow.pytorch.log_model) to save the trained model
...
![Basic Example of PyTorch with MLflow](/mlflow-website/docs/latest/assets/images/pytorch-guide-basic-example-ui-cf99aaf7644ae4e390f28f6be1ba594c.png)
...
![Basic PyTorch Saving](/mlflow-website/docs/latest/assets/images/pytorch-guide-basic-saving-af066edf360c780042fd3085792ec1d2.png)
...
![PyTorch Model Signature](/mlflow-website/docs/latest/assets/images/pytorch-guide-model-signature-f8e63d83e73f9283d985016616ae1cab.png)
