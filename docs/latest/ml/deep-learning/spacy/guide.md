...
MLflow provides native support for spaCy models through the [`mlflow.spacy.log_model()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.spacy.html#mlflow.spacy.log_model) function:
