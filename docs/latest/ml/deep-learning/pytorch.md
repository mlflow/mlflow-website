...
[](/mlflow-website/docs/latest/images/deep-learning/dl-training-ui.mp4)
...
You can customize system metrics collection frequency and behavior. See the **[System Metrics documentation](/mlflow-website/docs/latest/ml/tracking/system-metrics.md)** for detailed configuration options.
...
[Version and manage PyTorch models](/mlflow-website/docs/latest/ml/model-registry.md)
