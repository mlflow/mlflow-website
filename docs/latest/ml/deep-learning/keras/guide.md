...
* [`mlflow.log_metric()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.html#mlflow.log_metric) / [`mlflow.log_metrics()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.html#mlflow.log_metrics): Log metrics such as accuracy and loss during training
* [`mlflow.log_param()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.html#mlflow.log_param) / [`mlflow.log_params()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.html#mlflow.log_params): Log parameters such as learning rate and batch size
* [`mlflow.keras.log_model()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.keras.html#mlflow.keras.log_model): Save your Keras model to MLflow
* [`mlflow.log_artifact()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.html#mlflow.log_artifact): Log artifacts such as model checkpoints and plots
...
* **Log training parameters** at the beginning of training via [`mlflow.log_params()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.html#mlflow.log_params), including learning rate, batch size, epochs, etc.
* **Log model architecture** at the beginning of training via [`mlflow.log_artifact()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.html#mlflow.log_artifact). You can save the model summary as a text file
* **Log training and validation metrics** inside your training loop or callbacks via [`mlflow.log_metric()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.html#mlflow.log_metric)
* **Log your trained model** to MLflow via [`mlflow.keras.log_model()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.keras.html#mlflow.keras.log_model) at the end of training
* **\[Optional] Log model checkpoints** during training via [`mlflow.log_artifact()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.html#mlflow.log_artifact) to preserve intermediate training states
...
MLflow provides a built-in callback for Keras that simplifies experiment tracking. The [`mlflow.keras.MlflowCallback()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.keras.html#mlflow.keras.MlflowCallback) integrates seamlessly with your Keras training loop:
...
Save your trained Keras model using [`mlflow.keras.log_model()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.keras.html#mlflow.keras.log_model):
