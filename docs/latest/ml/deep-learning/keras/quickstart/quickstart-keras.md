...
[Download this notebook](https://raw.githubusercontent.com/mlflow/mlflow/master/docs/docs/classic-ml/deep-learning/keras/quickstart/quickstart-keras.ipynb)
...
## Import Packages / Configure Backend[​](#import-packages--configure-backend "Direct link to Import Packages / Configure Backend")
...
## Train Model (Default Callback)[​](#train-model-default-callback "Direct link to Train Model (Default Callback)")
...
### Log Per Epoch[​](#log-per-epoch "Direct link to Log Per Epoch")
...
### Log Results[​](#log-results "Direct link to Log Results")
...
### Log Per Batch[​](#log-per-batch "Direct link to Log Per Batch")
...
### Log Results[​](#log-results-1 "Direct link to Log Results")
