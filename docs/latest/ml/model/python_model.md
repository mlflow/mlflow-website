...
The [`mlflow.pyfunc`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.pyfunc.html#mlflow.pyfunc) module provides [save\_model()](/mlflow-website/docs/latest/api_reference/python_api/mlflow.pyfunc.html#mlflow.pyfunc.save_model) and

[log\_model()](/mlflow-website/docs/latest/api_reference/python_api/mlflow.pyfunc.html#mlflow.pyfunc.log_model) utilities for creating MLflow Models with the `python_function` flavor that contain user-specified code and *artifact* (file) dependencies.
...
There are two ways to define a PythonModel: Subclassing [`mlflow.pyfunc.PythonModel()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.pyfunc.html#mlflow.pyfunc.PythonModel) or defining a callable. This guide provides a complete walkthrough on how to define and use a custom PythonModel.
...
* **load\_context** Implement the load\_context method if the model requires additional context to be loaded. For more details, refer to [load\_context()](/mlflow-website/docs/latest/api_reference/python_api/mlflow.pyfunc.html#mlflow.pyfunc.PythonModel.load_context).
...
Use the pyfunc module to log a custom model with [`mlflow.pyfunc.log_model()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.pyfunc.html#mlflow.pyfunc.log_model).
...
Use [`mlflow.models.predict()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.models.html#mlflow.models.predict) API to validate the model dependencies and input data before deploy it. Check [MLflow Model Validation](/mlflow-website/docs/latest/ml/model.md#validate-models-before-deployment) for more details.
...
The final step to use your model in production is to deploy it. Follow [MLflow Model Deployment](/mlflow-website/docs/latest/ml/model.md#deployment_plugin) guide to deploy the model.
...
By subclassing [`mlflow.pyfunc.PythonModel()`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.pyfunc.html#mlflow.pyfunc.PythonModel), you can get data validation based on the type hints for free. The data validation works for both a PythonModel instance and a loaded PyFunc model.
