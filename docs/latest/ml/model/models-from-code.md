...
Models from Code is available in MLflow 2.12.2 and above. For earlier versions, use the legacy serialization methods outlined in the [Custom Python Model](/mlflow-website/docs/latest/ml/model.md#custom-python-models) documentation.
...
![Models from code comparison with legacy serialization](/mlflow-website/docs/latest/assets/images/models_from_code_journey-de9843c474c53ab2434d43a56b6ac3be.png)
...
1. Delete the MLflow run: Use the UI or [`delete_run()` API](/mlflow-website/docs/latest/api_reference/python_api/mlflow.client.html#mlflow.client.MlflowClient.delete_run)
...
* [Model API Documentation](/mlflow-website/docs/latest/ml/model.md#model-api)
* [Managing Dependencies in MLflow Models](/mlflow-website/docs/latest/ml/model/dependencies.md)
* [Custom Python Models](/mlflow-website/docs/latest/ml/model.md#custom-python-models)
