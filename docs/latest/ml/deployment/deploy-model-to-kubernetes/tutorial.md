...
* Training a linear regression model with [MLflow Tracking](/mlflow-website/docs/latest/ml/tracking.md).
* Conducting hyper-parameter tuning to find the best model.
* Packaging the model weights and dependencies as an [MLflow Model](/mlflow-website/docs/latest/ml/model.md).
* Testing model serving locally with [mlserver](https://mlserver.readthedocs.io/en/latest/) using the [mlflow models serve](/mlflow-website/docs/latest/api_reference/cli.html#mlflow-models-serve) command.
...
While KServe enables highly scalable and production-ready model serving, deploying your model there might require some effort. MLflow simplifies the process of deploying models to a Kubernetes cluster with KServe and MLServer. Additionally, it offers seamless **end-to-end model management** as a single place to manage the entire ML lifecycle. This includes [experiment tracking](/mlflow-website/docs/latest/ml/tracking.md), [model packaging](/mlflow-website/docs/latest/ml/model.md), [versioning](/mlflow-website/docs/latest/ml/model-registry.md), [evaluation](/mlflow-website/docs/latest/ml/evaluation.md), and [deployment](/mlflow-website/docs/latest/ml/deployment.md), which we will cover in this tutorial.
...
![](/mlflow-website/docs/latest/assets/images/tracking-ui-default-620cdc67da31f91f653210afe78de3b8.png)
...
![](/mlflow-website/docs/latest/assets/images/hyper-parameter-tuning-ui-88db40c21c63fb307e84629607985a73.png)
...
To learn more about hyperparameter tuning with MLflow, please refer to [Hyperparameter Tuning with MLflow and Optuna](/mlflow-website/docs/latest/ml/traditional-ml/tutorials/hyperparameter-tuning.md).
...
Since we are using autologging, MLflow automatically logs the [Model](/mlflow-website/docs/latest/ml/model.md) for each run. This process conveniently packages the model weight and dependencies in a ready-to-deploy format.

note

In practice, it is also recommended to use [MLflow Model Registry](/mlflow-website/docs/latest/ml/model-registry.md) for registering and managing your models.
...
If you opt for manual logging, you will need to log the model explicitly using the [`mlflow.sklearn.log_model`](/mlflow-website/docs/latest/api_reference/python_api/mlflow.sklearn.html#mlflow.sklearn.log_model) function, as shown below:
...
* [MLflow Tracking](/mlflow-website/docs/latest/ml/tracking.md) - Explore more about MLflow Tracking and various ways to manage experiments and models, such as team collaboration.
* [MLflow Model Registry](/mlflow-website/docs/latest/ml/model-registry.md) - Discover more about MLflow Model Registry for managing model versions and stages in a centralized model store.
* [MLflow Deployment](/mlflow-website/docs/latest/ml/deployment.md) - Learn more about MLflow deployment and different deployment targets.
