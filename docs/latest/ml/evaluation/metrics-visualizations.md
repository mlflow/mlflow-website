...
## Quick Start: Creating Custom Metrics[​](#quick-start-creating-custom-metrics "Direct link to Quick Start: Creating Custom Metrics")
...
### Metric Design Principles[​](#metric-design-principles "Direct link to Metric Design Principles")
...
### Visualization Best Practices[​](#visualization-best-practices "Direct link to Visualization Best Practices")
