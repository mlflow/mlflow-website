...
<BlogImage
  ...
  alt="Flow diagram: Claude Code → MLflow AI Gateway → Anthropic API, with Traces, Budgets, and Guardrails beneath the gateway"
  width="80%"
  center
/>
...
Everything described here ships with MLflow. Follow the [AI Gateway documentation for Claude Code](https://mlflow.org/docs/latest/genai/governance/ai-gateway/coding-agents/claude-code/) for full setup instructions, or jump straight to [OpenAI Codex](https://mlflow.org/docs/latest/genai/governance/ai-gateway/coding-agents/codex/) and [Gemini CLI](https://mlflow.org/docs/latest/genai/governance/ai-gateway/coding-agents/gemini-cli/) if you use those instead.
