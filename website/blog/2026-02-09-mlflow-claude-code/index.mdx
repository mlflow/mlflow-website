...
To start tracing your Claude Code sessions, run a single command in your project. Alternatively, you can set up the hook at the user level by following the [guide](https://mlflow.org/docs/latest/genai/tracing/integrations/listing/claude_code/) here.
...
### Tip 4: Automating Workflows with MLflow Skills
