---
title: "AI Observability for All TypeScript LLM Stacks"
...
In practical terms, any traces emitted from modern JS LLM stacks now lands in the same MLflow experiment UI as your Python services, complete with prompt/response payloads, token usage, tool results, and error metadata.
