...
While you may have a few scenarios in mind that test your agent, it's simply not scalable to manually chat with your agent for each user scenario or interaction, and on every iteration of your agent. You need reproducible and rigorous test cases that cover situations where the agent struggles.
