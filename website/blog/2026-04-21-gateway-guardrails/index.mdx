...
Then open the MLflow UI, navigate to **AI Gateway > Endpoints**, and add guardrails to any unified endpoint. For full configuration details, see the [Gateway documentation](https://mlflow.org/docs/latest/genai/governance/ai-gateway).
