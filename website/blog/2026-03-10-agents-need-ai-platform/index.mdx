...
<div style={{overflow: "hidden", borderRadius: "8px"}}><img src="/img/GenAI_home/GenAI_evaluation_darkmode.png" alt="MLflow Evaluation UI showing pass/fail scores for conciseness and hallucination across agent responses" style={{width: "100%"}} /></div>
