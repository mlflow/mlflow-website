...
<figure style={{ marginTop: "1.5rem", marginBottom: "2.5rem", maxWidth: "1100px", margin: "1.5rem auto 2.5rem" }}>
...
<i>MLflow is the only open source AI platform that provides unified agent observability, evaluation, version control, and governance.</i>
</figcaption>
</figure>
...
<img src="/img/blog/GenAI_trace_darkmode.png" alt="MLflow Tracing UI showing a hierarchical trace breakdown with LLM calls, tool invocations, and latency" style={{borderRadius: "8px", width: "100%"}} />
...
<div style={{overflow: "hidden", borderRadius: "8px"}}><img src="/img/blog/GenAI_evaluation_darkmode.png" alt="MLflow Evaluation UI showing pass/fail scores for conciseness and hallucination across agent responses" style={{width: "100%"}} /></div>
...
<img src="/img/blog/GenAI_prompts_darkmode.png" alt="MLflow Prompt Registry UI showing versioned prompts with aliases, diff history, and commit messages" style={{borderRadius: "8px", width: "100%"}} />
