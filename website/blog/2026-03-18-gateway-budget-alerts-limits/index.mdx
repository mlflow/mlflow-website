...
<div style={{ display: "flex", justifyContent: "center" }}>
  <img
    src={require("/img/blog/gateway-budget-thumbnail.png").default}
    style={{ width: "75%", borderRadius: "15px", marginBottom: "40px" }}
    alt="MLflow AI Gateway Budget Alerts and Limits overview"
  />
</div>
...
- **Reject**: Blocks all subsequent requests with an HTTP 429 response. The request that causes the overspend still completes — rejection applies only to requests that follow.
