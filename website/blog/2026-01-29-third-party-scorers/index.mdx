...
4. **Customize when needed.** For domain-specific requirements, MLflow provides the [make_judge](https://mlflow.org/docs/latest/genai/eval-monitor/scorers/llm-judge/make-judge/) and [guidelines](https://mlflow.org/docs/latest/genai/eval-monitor/scorers/llm-judge/guidelines/) APIs, allowing you to create judges tailored to your specific business logic or evaluation criteria.
