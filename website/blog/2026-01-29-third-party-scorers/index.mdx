...
authors: [samraj-moorjani, avesh-singh, jules-damji, somto-umeh, debu-sinha]
...
To turn evaluation results into actionable insights and real improvements, agent developers need more than just metrics. They need a complete [AI agent platform](/ai-platform) with a visual UI, search and filtering capabilities, datasets for reproducing issues and testing fixes, and tools for iterating on fixes. MLflow provides exactly this.
...
**RAGAS** (Retrieval Augmented Generation Assessment) is a specialized evaluation framework for RAG evaluation. Based on [research by Shahul Es et al.](https://arxiv.org/abs/2309.15217), RAGAS provides metrics such as Faithfulness, ContextRecall, and ContextPrecision specifically designed to evaluate retrieval quality and answer generation. MLflow integrates RAGAS metrics, including those for RAG and agent evaluation.
...
4. **Customize when needed.** For domain-specific requirements, MLflow provides the [make_judge](https://mlflow.org/docs/latest/genai/eval-monitor/scorers/llm-judge/custom-judges/create-custom-judge) and [guidelines](https://mlflow.org/docs/latest/genai/eval-monitor/scorers/llm-judge/guidelines/) APIs, allowing you to create judges tailored to your specific business logic or evaluation criteria.
...
This example illustrates how to use some of the DeepEval MLflow judges within a conversational bot, such as a customer technical support system, particularly in multi-turn scenarios. It helps gauge metrics like [Conversational Completeness](https://mlflow.org/docs/latest/api_reference/python_api/mlflow.genai.html#mlflow.genai.scorers.deepeval.ConversationCompleteness), [Knowledge Retention](https://mlflow.org/docs/latest/api_reference/python_api/mlflow.genai.html#mlflow.genai.scorers.deepeval.KnowledgeRetention), and [Topic Adherence](https://mlflow.org/docs/latest/api_reference/python_api/mlflow.genai.html#mlflow.genai.scorers.deepeval.TopicAdherence).

<video width="100%" controls autoPlay loop muted>
  <source src={require("./deepeval_multiturn.mp4").default} type="video/mp4" />
</video>
...
The complete example and instructions on how to use it can be found in [this GitHub Repository](https://github.com/dmatrix/mlflow-misc/tree/main/genai/agents/deepeval), along with an [IPython Notebook](https://github.com/dmatrix/mlflow-misc/blob/main/genai/agents/deepeval/customer_support_deepeval_demo.ipynb).
...
Join us for an [MLflow webinar](https://luma.com/mlflow-204) where we'll deep-dive into MLflow 3.9 features and showcase some of them.

We continually improve our MLflow GenAI capabilities, including even more judge integrations coming out soon! Stay tuned for discussions on [GitHub for roadmap updates](https://github.com/mlflow/mlflow/discussions/19855). For more information, check out the documentation and references below.

## Resources and References

- [MLflow Third-party Judges](https://mlflow.org/docs/latest/genai/eval-monitor/scorers/third-party/)
- [Ragas: Automated Evaluation of Retrieval Augmented Generation](https://arxiv.org/pdf/2309.15217)
- [Introduction to DeepEval Metrics](https://deepeval.com/docs/metrics-introduction)
...
- [MLflow DeepEval Multiturn Example](https://github.com/dmatrix/mlflow-misc/tree/main/genai/agents/deepeval)
- [Arize Phoenix: List of Available Metrics](https://arize.com/docs/phoenix/evaluation/running-pre-tested-evals)
