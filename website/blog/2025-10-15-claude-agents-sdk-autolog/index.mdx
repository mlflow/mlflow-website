---
title: "Rapidly Prototype and Evaluate Agents with Claude Agent SDK and MLflow"
...
## Why Quickly Building Agents is Hard
...
![MLflow Trace UI showing autotracing of the Claude Agent SDK](claude_code_tracing.gif)
...
The predict function is the code that runs your agent and produces a trace to evaluate. Here's a `predict_fn` for our travel agent working example:
...
This will generate evaluation results on your traces as well as a new run to store these results in one place:
...
- Learn about [Claude Code Auto-tracing](https://mlflow.org/docs/latest/genai/tracing/integrations/listing/claude_code/) for tracing the Claude Agent SDK and Claude Code CLI automatically
