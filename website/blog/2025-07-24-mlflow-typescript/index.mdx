...
thumbnail: /img/blog/mlflow-typescript.png
---

<img src={require("./mlflow-typescript-hero.png").default} alt="MLflow TypeScript SDK Hero" width="100%"/>
...
```bash
git clone https://github.com/mlflow/mlflow-typescript-demo
cd mlflow-typescript-demo
npm install
make run-full-stack
```
...
Once the application is running, you can start interacting with the chatbot at `http://localhost:5173`. Then navigate to the MLflow UI at `http://localhost:5000` to see the traces.
...
![Production Monitoring](https://assets.docs.databricks.com/_static/images/generative-ai/monitoring/monitoring-hero.gif)
