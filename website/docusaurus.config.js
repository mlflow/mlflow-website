...
var tailwind_config_cjs_1 = require("./plugins/tailwind-config.cjs");
var extended_blog_plugin_cjs_1 = require("./plugins/extended-blog-plugin.cjs");
// ensure baseUrl always ends in `/`
var baseUrl = (
  (_a = process.env.BASE_URL) !== null && _a !== void 0 ? _a : "/"
).replace(/\/?$/, "/");
var config = {
  title: "MLflow",
  ...
  plugins: [
    tailwind_config_cjs_1.default,
    [
      extended_blog_plugin_cjs_1.default,
      {
