...
import { LayoutContext } from "@site/src/components/Layout/Layout";
...
export default function BlogPostItems({
  ...
  if (isBlog) {
    ...
    return (
      <LayoutContext.Provider value="blue">
        <div className="flex flex-col mb-10 max-w-7xl mx-auto">
          <div className="flex flex-col-reverse md:flex-row gap-10">
            ...
            >
              ...
              <Heading level={2}>
                {firstBlogPost.content.metadata.title}
              </Heading>
