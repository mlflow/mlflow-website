...
const steps = [
  {
    ...
    description: "One command to get started. If you are not using Python, you can also setup MLflow via Docker.",
    time: "~30 seconds",
  ...
  },
  {
    ...
    description: "1 line of code to start capturing traces, metrics, parameters, from your LLM applications.",
    time: "~1 minute",
  ...
  },
  {
    number: "3",
    title: "View UI",
    description: "Start the MLflow server and explore the web UI.",
    time: "~1 minute",
              ...
              >
                ...
                <div className="flex-1 w-full p-6 rounded-xl border border-white/10 bg-white/5">
                  ...
                  <div className="rounded-lg bg-[#0d1117] border border-white/10 overflow-hidden mb-3">
                    <div className="flex items-center px-3 py-1.5 border-b border-white/10 bg-white/5">
