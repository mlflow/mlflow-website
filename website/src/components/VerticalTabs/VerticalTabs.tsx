...
>(({ className, label, description, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      "vertical-tabs-trigger w-full p-5 inline-flex whitespace-nowrap rounded-lg data-[state=active]:bg-[#fff]/4 data-[state=active]:text-foreground data-[state=active]:border data-[state=active]:border-[#fff]/8 cursor-pointer text-white",
      className,
    )}
    {...props}
  >
