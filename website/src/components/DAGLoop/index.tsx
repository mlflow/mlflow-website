          ...
          {steps.map((step, index) => (
            <div key={index} className={styles.mobileStepItem}>
              <div className={styles.mobileStepIndicator}>
                <div
                  className={`${styles.mobileStepNumber} ${step.isFocus ? styles.mobileFocusNode : ""}`}
                >
                  {step.icon ? (
                    <>
          ...
          {LoopIcon && loopBackDescription && (
            <div className={styles.mobileLoopBack}>
              ...
              <div className={styles.mobileLoopContent}>
                <h4 className={styles.mobileLoopTitle}>
                  {loopBackText || "Iterate"}
                </h4>
                <p className={styles.mobileLoopDescription}>
                  {loopBackDescription}
                </p>
              </div>
            </div>
        ...
        >
          ...
          {steps.map((step, index) => {
            ...
            return (
              <div
                key={index}
                className={`${styles.stepNode} ${step.isFocus ? styles.focusNode : ""}`}
                style={{
                  left: `${position.x}px`,
                  top: `${position.y}px`,
          ...
          {hoveredStep !== null && (
            ...
            >
              ...
              <p className={styles.tooltipDescription}>
                {steps[hoveredStep].detailedDescription ||
