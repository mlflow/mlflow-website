  ...
  return (
    ...
    >
      <div
        ...
        aria-hidden
      />
      <div className="pointer-events-none absolute inset-px rounded-[28px] border border-white/8" aria-hidden />
...
export function GlossyCardContainer({ children, className }: GlossyCardContainerProps) {
  return (
