...
const SEO_DESCRIPTION =
  "An AI Gateway is a centralized proxy that routes LLM and MCP requests, manages credentials, tracks costs, and enforces governance across providers. Learn how the MLflow AI Gateway delivers full observability, evaluation, and monitoring for agents and LLM applications — all open source.";
