          ...
          <GridItem>
            <div className="flex flex-col gap-10">
              ...
              <p className="text-white/60">
                ...
                Manually add additional examples. Datasets track lineage and
                version history.
              </p>
            </div>
            <FakeImage />
          ...
          <GridItem direction="reverse">
            <div className="flex flex-col gap-4">
              ...
              <p className="text-white/60 text-lg">
                ...
                models, code changes, etc) against the evaluation and regression
                datasets. Every variant is linked to its evaluation results so
          ...
          <GridItem width="wide">
            <div className="flex flex-col gap-4">
              ...
              <p className="text-white/60 text-lg">
                ...
                variants, and provides judge-driven insights into root causes to
                validate changes and identify further improvement opportunities.
              </p>
              <p className="text-white/60 text-lg">
