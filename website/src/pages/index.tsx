        ...
        <GlossyCardContainer>
          <GlossyCard>
            <Card
              ...
              bodySize="m"
              body="Enhance your GenAI applications with end-to-end tracking, observability, evaluations and monitoring, all in one integrated platform."
              padded
              rounded={false}
              cta={{
                href: "/genai",
          ...
          <GlossyCard>
            <Card
              ...
              bodySize="m"
              body="Streamline your machine learning workflows with end-to-end experiment tracking, model management, and deployment support."
              padded
              rounded={false}
              cta={{
                href: "/classical-ml",
