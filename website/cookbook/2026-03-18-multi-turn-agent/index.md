...
description: "Evaluate multi-turn customer support chat quality with MLflow's conversational scorers."
tags: [agents, evaluation, multi-turn]
---
...
- [Evaluate Conversations](https://mlflow.org/docs/latest/genai/eval-monitor/running-evaluation/multi-turn) -- Full reference for multi-turn evaluation with session tracing and conversation simulation
- [Built-in Scorers Reference](https://mlflow.org/docs/latest/genai/eval-monitor/scorers/llm-judge/predefined#multi-turn) -- All available conversational scorers including KnowledgeRetention, ConversationalSafety, and ConversationalRoleAdherence
