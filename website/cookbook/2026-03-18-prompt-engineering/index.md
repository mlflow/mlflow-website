...
description: "Version, evaluate, and promote prompt templates using MLflow's prompt registry and evaluation framework."
tags: [prompts, evaluation, registry]
---
...
- [End-to-End RAG Evaluation](/cookbook/rag-evaluation) — Add retrieval to your agent and evaluate both retrieval and generation quality
- [Built-in Scorers Reference](https://mlflow.org/docs/latest/genai/eval-monitor/scorers/llm-judge/predefined) — Full list of available scorers
- [Prompt Registry Guide](https://mlflow.org/docs/latest/genai/prompt-registry) — Deep dive into prompt versioning, aliases, and chat templates
