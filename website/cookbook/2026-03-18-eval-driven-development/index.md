...
description: "Use MLflow evaluation to find weaknesses in a GenAI application, fix them, and measure the improvement in a repeatable loop."
tags: [evaluation, development, prompts]
---
...
- [End-to-End RAG Evaluation](/cookbook/rag-evaluation) -- Apply the same loop to a RAG pipeline with retrieval-specific scorers
