...
description: "Instrument a production chatbot with MLflow Tracing and build latency dashboards, error monitors, and token usage reports."
...
- [Search Traces Reference](https://mlflow.org/docs/latest/genai/tracing/search-traces) -- Full query syntax for filtering traces
- [End-to-End RAG Evaluation](/cookbook/rag-evaluation) -- Evaluate retrieval and generation quality
- [Custom LLM Judges](/cookbook/custom-llm-judges) -- Build domain-specific evaluation judges
