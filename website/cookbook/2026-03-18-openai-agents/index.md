...
slug: openai-agents
description: "Build an e-commerce agent with OpenAI function calling, trace it with MLflow, and evaluate tool selection accuracy."
tags: [agents, tracing, evaluation, openai]
---
...
- [Tracing and Evaluating a LangGraph Agent](/cookbook/langgraph-agent) -- Apply similar patterns with LangGraph's agent framework
- [End-to-End RAG Evaluation](/cookbook/rag-evaluation) -- Evaluate retrieval and generation quality in RAG pipelines
- [Building Custom LLM Judges](/cookbook/custom-llm-judges) -- Create domain-specific judges for your use case
- [Built-in Scorers Reference](https://mlflow.org/docs/latest/genai/eval-monitor/scorers/llm-judge/predefined) -- Full list of available scorers including `Safety`, `Guidelines`, and `RelevanceToQuery`
