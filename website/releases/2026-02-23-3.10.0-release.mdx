...
Gain visibility into your LLM spending! MLflow now automatically extracts model information from LLM spans and calculates costs, with a new UI that renders model and cost data directly in your [trace views](/faq/llm-tracing). Additionally, costs are aggregated and broken down in the "Overview" tab, giving you granular insights into your LLM spend patterns.
