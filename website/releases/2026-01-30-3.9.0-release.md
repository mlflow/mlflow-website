...
sidebar_label: MLflow 3.9.0 Highlights
slug: 3.9.0
authors: [mlflow-maintainers]
---

MLflow 3.9.0 is a major release focused on GenAI capabilities, bringing powerful new features for building, monitoring, and optimizing AI agents. This release introduces an AI-powered assistant, comprehensive dashboards for agent performance, a new judge optimization algorithm, judge builder UI, continuous monitoring with LLM judges, and distributed tracing.
...
<video controls width="100%">
  <source src="/img/releases/3.9.0/trace_dashboard.mp4" type="video/mp4" />
</video>
...
<!-- IMAGE_PLACEHOLDER: Diagram showing MemAlign learning from feedback and retrieving examples -->
...
<!-- IMAGE_PLACEHOLDER: Screenshot of Judges tab showing configured judges and assessment results -->
...
<!-- IMAGE_PLACEHOLDER: Diagram showing trace context propagation across multiple services -->
